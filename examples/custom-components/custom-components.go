...
func StateLessComponent() spot.Element {
	return &ui.Button{
...
func StatefulNoProps(ctx *spot.RenderContext) spot.Element {
...
func StatefulWithProps(ctx *spot.RenderContext, initialTitle string) spot.Element {
	counter, setCounter := spot.UseState[int](ctx, 0)
...
func (r *StructComponent) Render(ctx *spot.RenderContext) spot.Element {
