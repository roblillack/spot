...
DatePickerPtr DatePicker_New(int goDatePickerId, int x, int y, int w, int h) {
  id nsDatePicker =
      [[[NSDatePicker alloc] initWithFrame:NSMakeRect(x, y, w, h)] autorelease];
...
void DatePicker_SetDate(DatePickerPtr datePickerPtr, const char *date,
                        const char *dateFormat) {
  NSDatePicker *datePicker = (NSDatePicker *)datePickerPtr;
  NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
  dateFormatter.dateFormat = [NSString stringWithUTF8String:dateFormat];
  NSDate *formattedDate =
      [dateFormatter dateFromString:[NSString stringWithUTF8String:date]];

  [datePicker setDateValue:formattedDate];
}

void DatePicker_SetMinimumDate(DatePickerPtr datePickerPtr, const char *date,
                               const char *dateFormat) {
  NSDatePicker *datePicker = (NSDatePicker *)datePickerPtr;
  NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
  dateFormatter.dateFormat = [NSString stringWithUTF8String:dateFormat];
...
void DatePicker_SetMaximumDate(DatePickerPtr datePickerPtr, const char *date,
                               const char *dateFormat) {
  NSDatePicker *datePicker = (NSDatePicker *)datePickerPtr;
  NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
  dateFormatter.dateFormat = [NSString stringWithUTF8String:dateFormat];
...
const char *DatePicker_Date(DatePickerPtr datePickerPtr,
                            const char *dateFormat) {
  NSDatePicker *datePicker = (NSDatePicker *)datePickerPtr;
  NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
  dateFormatter.dateFormat = [NSString stringWithUTF8String:dateFormat];
