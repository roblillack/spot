...
TextFieldPtr TextField_New(int goTextFieldId, int x, int y, int w, int h) {
  ...
  id nsTextField =
      [[[NSTextField alloc] initWithFrame:NSMakeRect(x, y, w, h)] autorelease];
...
const char *TextField_StringValue(TextFieldPtr textFieldPtr) {
  ...
  return
      [[textField stringValue] cStringUsingEncoding:NSISOLatin1StringEncoding];
}
...
void TextField_SetFontFamily(TextFieldPtr textFieldPtr,
                             const char *fontFamily) {
  NSTextField *textField = (NSTextField *)textFieldPtr;
  textField.font =
      [NSFont fontWithName:[NSString stringWithUTF8String:fontFamily]
...
void TextField_SetColor(TextFieldPtr textFieldPtr, const int r, const int g,
                        const int b, const int a) {
  NSTextField *textField = (NSTextField *)textFieldPtr;
  textField.textColor = [NSColor colorWithCalibratedRed:r / 255.f
                                                  green:g / 255.f
                                                   blue:b / 255.f
                                                  alpha:a / 255.f];
}

void TextField_SetBackgroundColor(TextFieldPtr textFieldPtr, const int r,
                                  const int g, const int b, const int a) {
  NSTextField *textField = (NSTextField *)textFieldPtr;
  textField.drawsBackground = true;
  textField.backgroundColor = [NSColor colorWithCalibratedRed:r / 255.f
                                                        green:g / 255.f
                                                         blue:b / 255.f
                                                        alpha:a / 255.f];
}

void TextField_SetBorderColor(TextFieldPtr textFieldPtr, const int r,
                              const int g, const int b, const int a) {
  NSTextField *textField = (NSTextField *)textFieldPtr;
...
void TextField_SetBorderWidth(TextFieldPtr textFieldPtr,
...
void TextField_SetDrawsBackground(TextFieldPtr textFieldPtr,
                                  const int drawsBackground) {
  NSTextField *textField = (NSTextField *)textFieldPtr;
