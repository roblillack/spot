...
| --------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------- | --------------------------------------------------------------------------- | --- | ----- |
| [Window](https://pkg.go.dev/github.com/roblillack/spot/ui#Window)           | Control representing a (top-level) window on the screen                       | Done                               | NSWindow                                      | [Fl_Window](https://www.fltk.org/doc-1.4/classFl__Window.html)              | TBD | TBD   |
| [Button](https://pkg.go.dev/github.com/roblillack/spot/ui#Button)           | Simple button to initiate an action                                           | Done                               | NSButton                                      | [Fl_Button](https://www.fltk.org/doc-1.4/classFl__Button.html)              | TBD | TBD   |
| [Label](https://pkg.go.dev/github.com/roblillack/spot/ui#Label)             | Simple, non-editable text label                                               | ?                                  | NSTextField                                   | [Fl_Output](https://www.fltk.org/doc-1.4/classFl__Output.html)              | TBD | TBD   |
| [Checkbox](https://pkg.go.dev/github.com/roblillack/spot/ui#Checkbox)       | Control offering the user a choice between two mutually exclusive options     | Done                               | NSButton                                      | [Fl_Check_Button](https://www.fltk.org/doc-1.4/classFl__Check__Button.html) | TBD | TBD   |
...
| [Slider](https://pkg.go.dev/github.com/roblillack/spot/ui#Slider)           | Horizontal slider input control                                               | Done                               | NSSlider                                      | [Fl_Slider](https://www.fltk.org/doc-1.4/classFl__Slider.html)              | TBD | TBD   |
| [Dial](https://pkg.go.dev/github.com/roblillack/spot/ui#Dial)               | Circular status control                                                       | Currently not supported by go-fltk | NSProgressIndicator (with `NSCircular` style) | [Fl_Dial](https://www.fltk.org/doc-1.4/classFl__Dial.html)                  | TBD | TBD   |
| Image                                                                       | An image control                                                              | Not started                        | NSImageView                                   | Image                                                                       | TBD | TBD   |
| [Dropdown](https://pkg.go.dev/github.com/roblillack/spot/ui#Dropdown)       | Drop-down menu to select a single item out of multiple options                | Done                               | NSPopUpButton                                 | [Fl_Choice](https://www.fltk.org/doc-1.4/classFl__Choice.html)              | TBD | TBD   |
| ComboBox                                                                    | A combined dropdown menu with text input                                      | Not started                        | NSComboBox                                    | ComboBox                                                                    | TBD | TBD   |
| [ProgressBar](https://pkg.go.dev/github.com/roblillack/spot/ui#ProgressBar) | Progress bar control to visualize the progression of a long-running operation | Done                               | NSProgress                                    | Progress                                                                    | TBD | TBD   |
| ListBox                                                                     | A list control                                                                | Not started                        | NSTableView                                   | List                                                                        | TBD | TBD   |
| [Spinner](https://pkg.go.dev/github.com/roblillack/spot/ui#Spinner)         | Number input control with up/down buttons                                     | FLTK only                          | NSStepper                                     | [Fl_Spinner](https://www.fltk.org/doc-1.4/classFl__Spinner.html)            | TBD | TBD   |
